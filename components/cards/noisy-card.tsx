...
const NoisyCard = ({
  ...
  return (
    <div
      style={style}
      className={cn("relative border border-border from-gray-50/80 to-gray-50/50 bg-gradient-to-b dark:from-background/90 dark:to-background p-4 shadow-md shadow-foreground/5 rounded-xl overflow-hidden", className)}
    >
