...
const CrafterCard: React.FC<CrafterCardProps> = ({}) => {
  return (
    <NoisyCard>
      <div
        className="relative p-[calc(1.5rem-1px)] rounded-lg bg-center bg-no-repeat bg-cover w-full blur-lg h-full bg-opacity-30 opacity-30"
        style={{
      ...
      <article className="absolute rounded-xl flex flex-col justify-center items-center inset-0 p-4 gap-2 bg-background/60 dark:bg-black/40">
        ...
        <div className="flex justify-center items-center w-full gap-4">
          ...
          <div className="flex flex-col gap-2">
            <Icon href="https://crafter-station.com" name={Other.Play}>
              Website
            </Icon>
            <Icon
