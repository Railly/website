...
export default function Footer() {
  return (
    <footer className="container max-w-3xl mx-auto mt-10">
      ...
      <section className="grid grid-cols-1 gap-4 p-4 mb:10 sm:mb-20 text-zinc-400 md:grid-cols-3 sm:grid-cols-2 place-items-center bg-zinc-50 dark:bg-zinc-900">
