const Zoom = ({
  ...
  <svg width={size} height={size} viewBox="0 0 256 256" version="1.1" preserveAspectRatio="xMidYMid">
    <title>Zoom</title>
    <defs>
      <linearGradient x1="23.666%" y1="95.6118%" x2="76.334%" y2="4.3882%" id="zoomLinearGradient-1">
        <stop stop-color="#0845BF" offset="5.791949e-05%"></stop>
        <stop stop-color="#0950DE" offset="19.11%"></stop>
        <stop stop-color="#0B59F6" offset="38.23%"></stop>
        <stop stop-color="#0B5CFF" offset="50%"></stop>
        <stop stop-color="#0E5EFE" offset="67.32%"></stop>
        <stop stop-color="#1665FC" offset="77.74%"></stop>
        <stop stop-color="#246FF9" offset="86.33%"></stop>
        <stop stop-color="#387FF4" offset="93.88%"></stop>
