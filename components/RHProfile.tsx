...
const RHProfile: React.FC<IProps> = ({
  ...
  return (
    <div
      className={`flex justify-center  rounded-full from-stone-300 to-stone-500 bg-gradient-to-b w-max ${
        getClassNames(size).parent
      }`}
    >
      <div
        className={`flex justify-center p-0.5 rounded-full bg-zinc-900/70
