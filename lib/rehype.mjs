...
const PRE = "overflow-x-auto py-2 text-[13px] bg-[#23272e] !font-mono !prose-code m-0 !rounded-t-none";
const CODE =
  "grid [&>span]:border-l-4 [&>span]:border-l-transparent [&>span]:pl-2 [&>span]:pr-3 !font-mono !prose-code";
const INLINE_BLOCK =
  "!whitespace-nowrap !border !border-border !px-1.5 !py-px !text-[14px] !rounded-md !bg-border/20 !text-foreground/80 !font-mono !prose-code";
const INLINE_CODE = "";
