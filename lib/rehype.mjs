...
const BLOCK = "overflow-hidden rounded-lg leading-6 shadow-lg mb-5 !font-mono";
const TITLE =
...
const INLINE_BLOCK =
  "whitespace-nowrap border border-hunter-black-900/40 dark:border-hunter-green-400/10 px-1.5 py-px text-[13px] rounded-md bg-hunter-black-100/70 dark:bg-white/5 whitespace-nowrap text-hunter-black-800 dark:text-hunter-green-200/80 !font-mono";
const INLINE_CODE = "";
