...
const TITLE =
  "rounded-t-md bg-zinc-200 bg-[#313740] px-3 py-1 font-mono text-xs !text-white/70 !text-black/70";
const PRE = "overflow-x-auto py-2 text-[13px] bg-zinc-100 bg-[#23272e]";
const CODE =
  "grid [&>span]:border-l-4 [&>span]:border-l-transparent [&>span]:pl-2 [&>span]:pr-3";
const INLINE_BLOCK =
  "whitespace-nowrap border border-zinc-200 border-zinc-100/10 px-1.5 py-px text-[14px] rounded-full bg-zinc-800/5 bg-zinc-700 text-black text-white before:content-['`'] after:content-['`']";
const INLINE_CODE = "";
...
const HIGHLIGHTED_LINE =
  "!border-l-indigo-800/70 bg-indigo-200/50 !border-l-cyan-300/70 bg-cyan-200/10 before:!text-indigo-700 before:!text-white/70";
