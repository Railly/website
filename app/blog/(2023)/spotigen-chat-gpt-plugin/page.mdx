export const title = "Spotigen: From Prompts to Instant Spotify Playlists";
export const description = "A look into how I built Spotigen, a Chat-GPT plugin that generates Spotify playlists based on your prompts.";
...
export const metadata = {
  ...
  openGraph: {
    ...
    description,
    images: [{
      url: "https://raillyhugo.com/api/og?title=" + encodeURIComponent(title) + "&description=" + encodeURIComponent(description) + "&date=" + encodeURIComponent("2023-05-17") + "&color=" + encodeURIComponent("#27C77F"),
      width: 1200,
      height: 600,
      alt: "Spotigen Chat-GPT Plugin"
    }]
  }
}
...
<Image src="/images/plugins-mail.png" width={1904} height={856} alt="Early access email for ChatGPT Plugins"/>
