export const metadata = {
  title: "OG Image Generation: From JSX to Image",
  description: "What are OG images, and how to generate them dynamically with @vercel/og.",
  openGraph: {
    title: "OG Image Generation: From JSX to Image",
    description: "What are OG images, and how to generate them dynamically with @vercel/og.",
    images: [
      {
        url: "https://raillyhugo.com/api/og?title=OG%20Image%20Generation%3A%20From%20JSX%20to%20Image&date=2022-10-16",
        width: 2233,
        height: 1112,
...
4. Add [linear gradient generator](https://github.com/Railly/website-2022/blob/main/pages/api/og.tsx#L29) function
