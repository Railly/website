...
export const metadata = {
  ...
  description: "An overview of how I set up Storybook in a Vite project, all challenges I faced, and the solutions I found.",
  openGraph: {
    title: "How To Setup Storybook with Vite + Example",
    description: "An overview of how I set up Storybook in a Vite project, all challenges I faced, and the solutions I found.",
    images: [
      {
        url: "http://raillyhugo.com/api/og?title=How%20To%20Setup%20Storybook%20with%20Vite%20%2B%20Example&date=2022-08-03",
        width: 1200,
        height: 600,
