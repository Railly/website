...
const About = () => {
  return (
    <section className="p-4 rounded-lg backdrop-blur-sm bg-white/30 dark:bg-black">
        ...
        <ol className="relative border-l border-gray-200 dark:border-gray-700">
          <li className="mb-10 ml-6">
            ...
            <h3 className="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">
              ...
              <span className="bg-indigo-100 text-indigo-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-indigo-200 dark:text-indigo-800 ml-3">
                Latest
              </span>
            </h3>
            ...
            <ul className="mb-4 text-base font-normal text-gray-800 dark:text-gray-400">
